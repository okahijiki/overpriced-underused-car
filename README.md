# overpriced-underused-car

クルマの稼働率・座席利用率・維持コストを試算するアプリ。

### データの出典<br>
#### 稼働率(初期値3%): <br>
野口悠紀雄氏(東洋経済オンライン)の4.2%<br>
https://toyokeizai.net/articles/-/316256<br>
enegaeru.comによる独自算出2%の平均値<br>
...
軽自動車価格(196万円): 自動車工業会 2025年度「軽自動車の使用実態調査」<br>
